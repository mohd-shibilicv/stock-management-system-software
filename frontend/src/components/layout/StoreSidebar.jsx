  ...
  return (
    <div className="w-20 md:w-64 bg-white p-4 h-screen border-r border-gray-300 flex flex-col">
      <Link to="/" className="mb-8 flex justify-center md:justify-start">
        <div className="hidden sm:block text-black-500 text-2xl font-bold">InventoryPro</div>
        <div className="block sm:hidden text-black-500 text-2xl font-bold"><Container /></div>
      </Link>
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Link
                  ...
                  className={`flex items-center space-x-2 p-2 rounded ${isActive("/store/notifications")}`}
                >
